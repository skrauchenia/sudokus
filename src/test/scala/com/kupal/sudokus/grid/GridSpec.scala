...
class GridSpec extends BaseSpec with GridMatcher {
  ...
  "Grid.cell" should {
    "return cell at given position" in new GridContext("simple1.txt") {
  ...
  "Grid.row" should {
    "return row at given position" in new GridContext("simple1.txt") {
      grid.row(1) must hasCellValues("8 0 0 6 0 9 1 0 2")
    }
  }

  "Grid.col" should {
    "return col at given position" in new GridContext("simple1.txt") {
      grid.col(1) must hasCellValues("1 0 0 0 0 0 0 0 5")
    }
  }

  "Grid.house" should {
    "return house at given position" in new GridContext("simple1.txt") {
